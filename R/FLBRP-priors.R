...
#' Calculate priors for biomass dynamic models
#' 
#' @description Calculates priors for Pella-Tomlinson production models from FLBRP, FLStock, or FLStocks objects
#' 
#' @param object An object of class FLBRP, FLStock, or FLStocks
#' @param nmin Numeric vector for minimum years (for FLStock method)
#' @param nmax Numeric vector for maximum years (for FLStock method)
#' 
#' @return An FLPar object (for FLBRP) or data.frame (for FLStock/FLStocks) containing prior parameters
#' 
#' @rdname calcPriors
#' @export
setGeneric("calcPriors", function(object, ...) standardGeneric("calcPriors"))
